...
class LdaMallet(utils.SaveLoad, basemodel.BaseTopicModel):
    ...
    def __init__(self, mallet_path, corpus=None, num_topics=100, alpha=50, id2word=None, workers=4, prefix=None,
                 optimize_interval=0, iterations=2000, topic_threshold=0.0, random_seed=0, data_dir=None):
        """
    ...
    def __getitem__(self, bow, iterations=2000):
    ...
    def show_topics(self, num_topics=10, num_words=10, log=False, formatted=True):
        ...
        for i in chosen_topics:
            ...
            shown.append(('{}: {}'.format(i, self.id2word[i]), topic))
            if log:
...
def malletmodel2ldamodel(mallet_model, gamma_threshold=0.001, iterations=50):
    ...
    model_gensim = LdaModel(
        ...
        iterations=mallet_model.iterations, gamma_threshold=gamma_threshold,
        dtype=numpy.float32
    )
